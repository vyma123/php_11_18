...
<div class="ui modal product_box">
  ...
  <form class="ui form form_add_products" class='editProduct' id="saveProduct" enctype="multipart/form-data">
    ...
    <div class="field">
      <label>Product Name<span class="required">(Required)</span></label>
    ...
    <div class="field">
      <label>Price<span class="required">(Required)</label>
      <input type="text" name="price" id="price" placeholder="Price">
    </div>
    <div class="field featured_image_box">
      <label>Featured Image<span class="required">(Required)</label>
